...
/**
 * Crafting recipe: 1x material + 1x forge hammer -> 1x plate.
 *
 * <p>The hammer remains in the grid and loses 1 durability per craft.</p>
 */
public final class HammerPlateRecipe extends SpecialCraftingRecipe {

    private final Ingredient tool;
    private final Ingredient material;
    private final ItemStack result;

    public HammerPlateRecipe(Identifier id,
