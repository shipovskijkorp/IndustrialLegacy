    ...
    public static final ItemGroup MAIN = Registry.register(
            ...
            FabricItemGroup.builder()
                    ...
                    .entries((ctx, entries) -> {
                        ...
                        add.accept(ModBlocks.STIRLING_GENERATOR);
                        add.accept(ModBlocks.FLUID_HEAT_GENERATOR);
                        add.accept(ModBlocks.RT_HEAT_GENERATOR);
                        ...
                        add.accept(ModBlocks.FOAM);
                        add.accept(ModBlocks.REINFORCED_FOAM);
                        add.accept(ModBlocks.FOAM_CONCRETE);
                        add.accept(ModBlocks.WHITE_FOAM_CONCRETE);
                        add.accept(ModBlocks.ORANGE_FOAM_CONCRETE);
                        add.accept(ModBlocks.MAGENTA_FOAM_CONCRETE);
                        add.accept(ModBlocks.LIGHT_BLUE_FOAM_CONCRETE);
                        add.accept(ModBlocks.YELLOW_FOAM_CONCRETE);
                        add.accept(ModBlocks.LIME_FOAM_CONCRETE);
                        add.accept(ModBlocks.PINK_FOAM_CONCRETE);
                        add.accept(ModBlocks.GRAY_FOAM_CONCRETE);
                        add.accept(ModBlocks.LIGHT_GRAY_FOAM_CONCRETE);
                        add.accept(ModBlocks.CYAN_FOAM_CONCRETE);
                        add.accept(ModBlocks.PURPLE_FOAM_CONCRETE);
                        add.accept(ModBlocks.BLUE_FOAM_CONCRETE);
                        add.accept(ModBlocks.BROWN_FOAM_CONCRETE);
                        add.accept(ModBlocks.GREEN_FOAM_CONCRETE);
                        add.accept(ModBlocks.RED_FOAM_CONCRETE);
                        add.accept(ModBlocks.BLACK_FOAM_CONCRETE);
