...
public class EvTransformerScreen extends HandledScreen<EvTransformerScreenHandler> {
    private static final Identifier BACKGROUND = new Identifier(IndustrialLegacy.MOD_ID, "textures/gui/guitransfomer.png");

    public EvTransformerScreen(EvTransformerScreenHandler handler, PlayerInventory inventory, Text title) {
