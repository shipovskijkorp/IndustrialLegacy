...
public final class ToolboxScreen extends HandledScreen<ToolboxScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(IndustrialLegacy.MOD_ID, "textures/gui/guitoolbox.png");
