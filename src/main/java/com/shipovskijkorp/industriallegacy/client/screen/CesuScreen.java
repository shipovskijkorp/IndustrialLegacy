...
public class CesuScreen extends HandledScreen<CesuScreenHandler> {
    ...
    public CesuScreen(CesuScreenHandler handler, net.minecraft.entity.player.PlayerInventory inventory, Text title) {
