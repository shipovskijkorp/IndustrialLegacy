...
public class MvTransformerScreen extends HandledScreen<MvTransformerScreenHandler> {
    private static final Identifier BACKGROUND = new Identifier(IndustrialLegacy.MOD_ID, "textures/gui/guitransfomer.png");

    public MvTransformerScreen(MvTransformerScreenHandler handler, PlayerInventory inventory, Text title) {
