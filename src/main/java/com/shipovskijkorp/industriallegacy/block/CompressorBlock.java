...
public class CompressorBlock extends BlockWithEntity {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, ModBlockEntities.COMPRESSOR, CompressorBlockEntity::tick);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (be instanceof CompressorBlockEntity mac) {
            player.openHandledScreen(mac);
        }
