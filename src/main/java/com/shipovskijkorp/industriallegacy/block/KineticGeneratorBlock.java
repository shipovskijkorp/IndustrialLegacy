...
public class KineticGeneratorBlock extends BlockWithEntity {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (be instanceof KineticGeneratorBlockEntity kinetic) {
            player.openHandledScreen(kinetic);
    ...
    public <T extends BlockEntity> @Nullable BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, ModBlockEntities.KINETIC_GENERATOR, KineticGeneratorBlockEntity::tick);
    }
}
