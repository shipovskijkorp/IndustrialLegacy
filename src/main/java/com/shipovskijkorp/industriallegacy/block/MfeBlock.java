...
/**
 * MFE (МФЭ) storage block (IC2 Exp semantics).
 *
...
public class MfeBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        ...
        if (!world.isClient && world.getBlockEntity(pos) instanceof MfeBlockEntity storage && itemStack.getItem() instanceof EnergyMachineBlockItem energyItem) {
    ...
    public int getWeakRedstonePower(BlockState state, BlockView world, BlockPos pos, Direction direction) {
        ...
        if (be instanceof MfeBlockEntity mfe) {
            return mfe.getRedstoneOutputLevel();
        }
        return 0;
    }
    ...
    public <T extends BlockEntity> @Nullable BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return checkType(type, ModBlockEntities.MFE, MfeBlockEntity::tick);
    }
