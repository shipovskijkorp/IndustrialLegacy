...
public class SemifluidGeneratorBlock extends BlockWithEntity {
    ...
    public SemifluidGeneratorBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (be instanceof SemifluidGeneratorBlockEntity gen) {
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new SemifluidGeneratorBlockEntity(pos, state);
    }

    @Override
    public <T extends BlockEntity> @Nullable BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, ModBlockEntities.SEMIFLUID_GENERATOR, SemifluidGeneratorBlockEntity::tick);
    }
}
