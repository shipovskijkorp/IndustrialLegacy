...
public class PumpBlock extends BlockWithEntity {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        // IL pump uses the front face as the intake side, so make it face the placer.
    ...
    public <T extends BlockEntity> @Nullable BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, ModBlockEntities.PUMP, PumpBlockEntity::tick);
    }
}
