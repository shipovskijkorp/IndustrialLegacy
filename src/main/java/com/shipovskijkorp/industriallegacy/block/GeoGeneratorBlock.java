...
public class GeoGeneratorBlock extends BlockWithEntity {
    ...
    public GeoGeneratorBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (be instanceof GeoGeneratorBlockEntity gen) {
    ...
    public <T extends BlockEntity> @Nullable BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, ModBlockEntities.GEO_GENERATOR, GeoGeneratorBlockEntity::tick);
    }
}
