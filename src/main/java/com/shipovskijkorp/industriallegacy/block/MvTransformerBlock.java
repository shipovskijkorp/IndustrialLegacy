 ...
 */
public class MvTransformerBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final DirectionProperty DOT = Properties.FACING;
    public static final BooleanProperty ACTIVE = BooleanProperty.of("active");

    public MvTransformerBlock(Settings settings) {
        super(settings);
    ...
    public <T extends BlockEntity> @Nullable BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return checkType(type, ModBlockEntities.MV_TRANSFORMER, MvTransformerBlockEntity::tick);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!world.isClient) {
            ...
            if (be instanceof MvTransformerBlockEntity transformer) {
