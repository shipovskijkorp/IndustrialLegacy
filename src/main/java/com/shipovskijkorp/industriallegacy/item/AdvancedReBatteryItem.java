 ...
 * - max stack: 16
 *
 * Energy is stored in NBT. Newly crafted battery is empty (0 EU).
 */
public final class AdvancedReBatteryItem extends Item implements IElectricItem {

    public static final long CAPACITY_EU = 100_000L;
    public static final long TRANSFER_LIMIT_EU_T = 256L;
    public static final int TIER = 2;

    private static final String NBT_ENERGY = "energy";

    public AdvancedReBatteryItem(Settings settings) {
        super(settings);
    }
